...
| :-- | :-- | --: | --: | --: | :-- |
| **1**/5 | 🟤 Raw data is missing | **12** | 12 | **8.5%** | #8B4513 |
| **2**/5 | 🔴 Raw data is difficult to parse | **22** | 22 | **15.5%** | #FF0000 |
| **3**/5 | 🟠 Data is missing | **108** | 108 | **76.1%** | #FFA500 |


```mermaid
%%{init: {"theme": "base", "themeVariables": {"pie1": "#8B4513", "pie2": "#FF0000", "pie3": "#FFA500"}}}%%
pie title Final Report Build Status
"🟤 Raw data is missing" : 12
