...
```json
{
    "House": {
        "Time:2012": {
            ...
            "ToiletFacilities:no_toilet_open": {
                "Count": "Int:88280"
            }
        },
        "Time:2024": {
...
- Source File: [lanka_data.json (1.2 KB)](../../../../data/final-report-tables/chapter-11/11.15-Percentage-Distribution-of-Households-by-Type-of-Toilet-Facilities-2012-and-2024/lanka_data.json)
